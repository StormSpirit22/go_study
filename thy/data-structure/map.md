...
![img](../../.go_study/assets/images3/map-5.png)
...
![img](../../.go_study/assets/images3/map-6.png)
...
![img](../../.go_study/assets/images3/map-7.png)

扩容前

扩容完成后，overflow bucket 消失了，key 都集中到了一个 bucket，更为紧凑了，提高了查找的效率。

![img](../../.go_study/assets/images3/map-8.png)

same size 扩容

假设触发了 2 倍的扩容，那么扩容完成后，老 buckets 中的 key 分裂到了 2 个 新的 bucket。一个在 x part，一个在 y 的 part。依据是 hash 的 lowbits。新 map 中 `0-3` 称为 x part，`4-7` 称为 y part。

![img](../../.go_study/assets/images3/map-9.png)
