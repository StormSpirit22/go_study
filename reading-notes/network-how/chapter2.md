...
![协议栈内部结构](../../.go_study/assets/network-how/2.1-1.png)
...
![netstat](../../.go_study/assets/network-how/2.1-2.png)
...
![image-20220523154907140](../../.go_study/assets/network-how/2.1-3.png)
...
![消息收发操作](../../.go_study/assets/network-how/2.1-4.png)
...
![tcp头部格式](../../.go_study/assets/network-how/2.2-1.png)
...
![滑动窗口与接收缓冲区](../../.go_study/assets/network-how/2.3-5.png)
...
![断开连接的交互过程](../../.go_study/assets/network-how/2.4-1.png)主动关闭连接方在 TCP 四次挥手中发送完最后一次 ACK 信号结束后，开始进入 time-wait 状态，而不会马上删除套接字。time-wait 的持续时间为2MSL. MSL是Maximum Segment Lifetime, 译为“报文最大生存时间”。
...
![TCP的总体流程](../../.go_study/assets/network-how/2.4-2.png)
...
![包的基本结构](../../.go_study/assets/network-how/2.5-1.png)

发送方、接收方和转发设备：

![发送方、接收方和转发设备](../../.go_study/assets/network-how/2.5-2.png)
...
![IP网络包的传输过程](../../.go_study/assets/network-how/2.5-3.png)



![路由表示例](../../.go_study/assets/network-how/2.5-4.png)
...
![用ARP查询MAC地址](../../.go_study/assets/network-how/2.5-6.png)
...
![网卡](../../.go_study/assets/network-how/2.5-7.png)